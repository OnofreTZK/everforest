...
if s:configuration.enable_italic
  ...
  call everforest#highlight('Conditional', s:palette.orange_red, s:palette.none)
  call everforest#highlight('Repeat', s:palette.orange_red, s:palette.none)
  call everforest#highlight('Keyword', s:palette.orange_red, s:palette.none)
  call everforest#highlight('Typedef', s:palette.orange_red, s:palette.none)
  call everforest#highlight('Exception', s:palette.orange_red, s:palette.none)
  call everforest#highlight('Statement', s:palette.orange_red, s:palette.none)
endif
...
call everforest#highlight('Constant', s:palette.lemon_green, s:palette.none)
call everforest#highlight('Macro', s:palette.lemon_green, s:palette.none)
